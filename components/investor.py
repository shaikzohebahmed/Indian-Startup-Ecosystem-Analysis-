...
class Investor:
    ...
    def plot_biggest_investment(self, investor_name):
        ...
        biggest_investment_df = self.investor_analysis.biggest_investments(investor_name)
        fig = px.bar(biggest_investment_df, x='startup', y='amount')
    ...
    def plot_invested_type(self, investor_name):
        ...
        investment_type_df = self.investor_analysis.invested_round(investor_name)
        fig = px.pie(investment_type_df, values='amount', names='round')
        st.plotly_chart(fig, use_container_width=True)
